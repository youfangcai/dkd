...
public class TaskController extends BaseController {
    ...
    public TableDataInfo list(Task task) {
        startPage();
        List<TaskVo> list = taskService.getTaskList(task);
    ...
    @PostMapping
    public AjaxResult add(@RequestBody TaskDto taskDto) throws ServerException {
        // 设置指派人的id
    ...
    @Log(title = "工单", businessType = BusinessType.UPDATE)
    @PutMapping("/cancel")
    public AjaxResult cancelTask(@RequestBody Task task) throws ServerException {
