...
public class SkuServiceImpl implements ISkuService 
{
     ...
     */
    @Override
    public int importSkus(List<Sku> skus) {
        return skuMapper.insertSkuBatch(skus);
    }
    ...
    {
        /* 1 逻辑外键的实现*/
        int count = channelService.countChannelSelectBySkuIds(skuIds);
        if (count > 0) {
            throw new ServiceException("商品管理外键关联了售货机货道，请先删除售货机货道");
        }
